...
unsigned char Df_Key[24] = {0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88,0x88,0x77,0x66,0x55,0x44,0x33,0x22,0x11};
//unsigned char Df_Key[24] = "\x12\x34\x56\x78\x90\x12\x34\x56\x78\x90\x12\x34\x56\x78\x90\x12\x12\x34\x56\x78\x90\x12\x34\x56";

unsigned char  mingwen_start[255]={0};
unsigned char  mingwen_result[255]={0};
//static unsigned char mingwen_test[8]="\xA0\x00\x00\x00\x03\x86\x98\x07";
unsigned char  miwen_start[255]={0};
unsigned char  miwen_result[255]={0};
//static unsigned char miwen_result[8] ="\x4D\xAB\x92\x32\xD2\xCC\x4B\x90";
...
// void three_des_test(void)
// {
//	 memset(miwen_test_result, 0, 8);
//	 memset(mingwen_result, 0, 8);
//	 des_en3(Df_Key, mingwen_test, 8, miwen_test_result);
//	 
//	 des_de3(Df_Key, miwen_test_result, 8, mingwen_result);
// }
