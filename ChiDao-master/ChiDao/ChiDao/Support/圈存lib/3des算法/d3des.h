...
typedef union {
	...
	//增加外部调用变量声明
	extern unsigned char Df_Key[24];
	
	extern unsigned char  mingwen_start[255];
	extern unsigned char  mingwen_result[255];

	extern unsigned char  miwen_start[255];
	extern unsigned char  miwen_result[255];
