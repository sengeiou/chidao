...
-(void)creatUI{
    ...
    [_registerBtn setTitle:@"确 认" forState:UIControlStateNormal];
    [_registerBtn addTarget:self action:@selector(findPWDClick) forControlEvents:UIControlEventTouchUpInside];
