...
@implementation HisuntechLoadingView

static HisuntechLoadingView *mLoadingView = nil;
...
- (id)initIsLikeSynchro:(BOOL)isLikeSynchro{
    ...
    if (isLikeSynchro) {
        ...
        self = [super initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width-150)/2, ([UIApplication sharedApplication].keyWindow.bounds.size.height-80)/2, 150, 80)];
