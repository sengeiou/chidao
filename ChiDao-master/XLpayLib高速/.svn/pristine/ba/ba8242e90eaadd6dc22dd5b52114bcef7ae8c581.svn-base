...
#import "HisuntechQuickDebitPayCell.h"

@implementation HisuntechQuickDebitPayCell
...
- (void)createUI
{
    ...
    self.btnSelect.frame = CGRectMake(20, 12, 27, 26);
    ...
    _debitPay = [[UILabel alloc]initWithFrame:CGRectMake(64, 14, 111, 21)];
